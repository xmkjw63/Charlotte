...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/smooth-scrolling.js@1.0.0"></script>
</head>
<?php flush(); ?>
    ...
    <div class="k-header">
        ...
        <?php if (kratos_option('top_img_switch', true)) { ?>
            <div class="banner">
                ...
                <div class="content text-center" style="background-image: url(http://api.x-xh.cn/xjg/z.php);">
